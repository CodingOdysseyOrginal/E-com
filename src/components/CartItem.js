...
const CartItem = ({ item }) => {
  ...
  return (
    <div className="flex gap-x-4 py-2 lg:px-6 border-b border-orange-200 w-full font-light text-gray-800">
      <div className="w-full min-h-[150px] flex items-center gap-x-4">
        ...
        <div className="w-full flex flex-col">
          ...
          <div className="bg-orange-200 flex gap-x-2 h-[36px] text-sm">
            {/*qty*/}
            <div className="flex flex-1 max-w-[100px] bg-orange-400 items-center h-full border text-primary font-medium">
              {/*minus icon*/}
